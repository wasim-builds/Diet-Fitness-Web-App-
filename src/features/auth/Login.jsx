    ...
    <div className="flex min-h-screen bg-[#0B1120] text-slate-50 selection:bg-green-500/30">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-20 left-16 max-w-lg">
          ...
          >
            Your journey to a stronger you begins here.
          </motion.h2>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Join thousands of members crushing their fitness goals daily with AI-powered coaching.
          </motion.p>
        </div>
      </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-green-500 hover:text-green-400 font-medium">Forgot Password?</a>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="flex items-center">
              <input
                id="remember-me"
                type="checkbox"
                className="h-4 w-4 rounded border-white/10 bg-[#0B1120]/50 text-green-500 focus:ring-green-500 focus:ring-offset-[#0B1120]"
              />
